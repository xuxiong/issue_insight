...
class TestStateFiltering:
    ...
    def test_state_filter_open_only(self):
        ...
        issues = [
            self.create_test_issue(
                id=1, number=101, state=IssueState.OPEN, title="Open issue 1"
            ),
            self.create_test_issue(
                id=2, number=102, state=IssueState.CLOSED, title="Closed issue 1"
            ),
            self.create_test_issue(
                id=3, number=103, state=IssueState.OPEN, title="Open issue 2"
            ),
        ]
    ...
    def test_state_filter_closed_only(self):
        ...
        issues = [
            self.create_test_issue(
                id=1, number=101, state=IssueState.OPEN, title="Open issue"
            ),
            self.create_test_issue(
                id=2, number=102, state=IssueState.CLOSED, title="Closed issue 1"
            ),
            self.create_test_issue(
                id=3, number=103, state=IssueState.CLOSED, title="Closed issue 2"
            ),
        ]
...
class TestLabelFiltering:
    ...
    def test_label_filter_any_logic_single_label(self):
        ...
        issues = [
            ...
            self.create_test_issue_with_labels(
                102, "Enhancement issue", ["enhancement"]
            ),
            self.create_test_issue_with_labels(
                103, "Documentation issue", ["documentation"]
            ),
    ...
    def test_label_filter_any_logic_multiple_labels(self):
        ...
        issues = [
            ...
            self.create_test_issue_with_labels(
                104, "Both labels", ["bug", "enhancement"]
            ),
        ]
    ...
    def test_label_filter_all_logic_multiple_labels(self):
        ...
        issues = [
            ...
            self.create_test_issue_with_labels(
                102, "Enhancement only", ["enhancement"]
            ),
            self.create_test_issue_with_labels(
                103, "Documentation issue", ["documentation"]
            ),
            ...
            self.create_test_issue_with_labels(
                105, "All labels", ["bug", "enhancement", "documentation"]
            ),
        ]
    ...
    def test_label_filter_no_matches(self):
        ...
        issues = [
            self.create_test_issue_with_labels(
                101, "Documentation issue", ["documentation"]
            ),
...
class TestAssigneeFiltering:
    ...
    def test_assignee_filter_any_logic_single_assignee(self):
        ...
        issues = [
            self.create_test_issue_with_assignees(
                101, "Assigned to contributor1", ["contributor1"]
            ),
            self.create_test_issue_with_assignees(
                102, "Assigned to contributor2", ["contributor2"]
            ),
    ...
    def test_assignee_filter_any_logic_multiple_assignees(self):
        ...
        issues = [
            ...
            self.create_test_issue_with_assignees(
                103, "Assigned to contributor3", ["contributor3"]
            ),
            self.create_test_issue_with_assignees(
                104, "Both contributors", ["contributor1", "contributor2"]
            ),
        ]
    ...
    def test_assignee_filter_all_logic_multiple_assignees(self):
        ...
        issues = [
            self.create_test_issue_with_assignees(
                101, "Only contributor1", ["contributor1"]
            ),
            self.create_test_issue_with_assignees(
                102, "Only contributor2", ["contributor2"]
            ),
            self.create_test_issue_with_assignees(
                103, "Both contributors", ["contributor1", "contributor2"]
            ),
    ...
    def test_assignee_filter_empty_assignees_list(self):
        ...
        issues = [
            self.create_test_issue_with_assignees(
                101, "Assigned issue", ["contributor1"]
            ),
...
class TestCombinedFiltering:
    ...
    def create_complex_issue(
        self, number, title, state, labels, assignees, comment_count
    ):
        """Helper to create complex test issues."""
        label_objects = [
            Label(id=i + 1, name=l, color="ff0000", description=l)
        ...
        assignee_objects = [
            User(
                id=i + 2,
                username=a,
                display_name=a.capitalize(),
                avatar_url=f"https://github.com/{a}.png",
                is_bot=False,
            )
    ...
    def test_combined_state_and_labels(self):
        ...
        issues = [
            ...
            self.create_complex_issue(
                102, "Open enhancement", IssueState.OPEN, ["enhancement"], [], 5
            ),
            self.create_complex_issue(
                103, "Closed bug", IssueState.CLOSED, ["bug"], [], 7
            ),
            self.create_complex_issue(
                104, "Open doc", IssueState.OPEN, ["documentation"], [], 2
            ),
        ]

        criteria = FilterCriteria(
            state=IssueState.OPEN, labels=["bug"], any_labels=True, min_comments=3
        )
    ...
    def test_combined_labels_and_assignees(self):
        ...
        issues = [
            ...
            self.create_complex_issue(
                103, "Bug unassigned", IssueState.OPEN, ["bug"], [], 3
            ),
            self.create_complex_issue(
                104,
                "Doc by contributor1",
        ...
        assert (
            len(filtered_issues) == 2
        )  # Bug and enhancement with >=4 comments and matching assignees
    ...
    def test_all_filters_combined(self):
        ...
        issues = [
            ...
            self.create_complex_issue(
                104, "Unassigned", IssueState.OPEN, ["enhancement"], [], 9
            ),
